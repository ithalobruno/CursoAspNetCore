...
namespace DevIO.App.Extensions
{
    ...
    public class ApagaElementoByClaimTagHelper :TagHelper
    {
        ...
        {
            _contentAccessor = contextAccessor;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var temAcesso = CustomAuthorization.ValidarClaimUsuario(_contentAccessor.HttpContext, IdentityClaimName, IdentityClaimValue);
    ...
    public class ApagaElementoByActionTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var action = _contentAccessor.HttpContext.GetRouteData().Values["action"].ToString();
